        ...
        <div id="topbar">
            <div id="topnav">
                <ul>
                    ...
                    <li class="active"><a href="spanyol.php">Liga Spanyol</a></li>
        ...
        <div id="container">
            <div id="content">
                <div id="featured_post">
                    ...
                    $sql = "SELECT * FROM artikel WHERE kategori='liga_spanyol' ORDER BY tanggal_dibuat DESC LIMIT 1";
                ...
                <div id="hpage_latest">
                    <ul>
                        ...
                        $sql_latest = "SELECT * FROM artikel WHERE kategori='liga_spanyol' ORDER BY tanggal_dibuat DESC LIMIT 3 OFFSET 1";
            ...
            <div id="column">
                <ul id="latestnews">
                    ...
                    $sql_news = "SELECT * FROM artikel WHERE kategori='liga_spanyol' ORDER BY tanggal_dibuat DESC LIMIT 3 OFFSET 4";
