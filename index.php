    ...
    <div id="container">
      <div id="content">
        <div id="featured_post">
          ...
          $sql = "SELECT * FROM artikel ORDER BY tanggal_dibuat DESC LIMIT 1";
        ...
        <div id="hpage_latest">
          <ul>
            <?php
            // Mengambil beberapa berita terbaru untuk dimasukkan ke dalam hpage_latest
            $sql_latest = "SELECT * FROM artikel ORDER BY tanggal_dibuat DESC LIMIT 3 OFFSET 1";
      ...
      <div id="column">
        <ul id="latestnews">
          <?php
          // Mengambil beberapa berita lainnya untuk dimasukkan ke dalam latestnews
          $sql_news = "SELECT * FROM artikel ORDER BY tanggal_dibuat DESC LIMIT 3 OFFSET 4";
