...
<body id="top">
        ...
        <div id="container">
            <div id="content">
                <div id="featured_post">
                    <?php
                    // Mengambil berita utama dari kategori Liga Spanyol
                    $sql = "SELECT * FROM artikel WHERE kategori='liga_indonesia' ORDER BY tanggal_dibuat DESC LIMIT 1";
                ...
                <div id="hpage_latest">
                    <ul>
                        <?php
                        // Mengambil beberapa berita terbaru dari kategori Liga Spanyol
                        $sql_latest = "SELECT * FROM artikel WHERE kategori='liga_indonesia' ORDER BY tanggal_dibuat DESC LIMIT 3 OFFSET 1";
            ...
            <div id="column">
                <ul id="latestnews">
                    <?php
                    // Mengambil beberapa berita lainnya dari kategori Liga Spanyol
                    $sql_news = "SELECT * FROM artikel WHERE kategori='liga_indonesia' ORDER BY tanggal_dibuat DESC LIMIT 3 OFFSET 4";
    ...
    <div class="wrapper col5">
        <div class="gallery">
            ...
            <ul>
                <?php
                // Mengambil semua gambar dari tabel kategori Liga Spanyol
                $sql = "SELECT gambar FROM artikel WHERE kategori='liga_indonesia'";
                $result = $conn->query($sql);
